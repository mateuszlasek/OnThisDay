...
class EventRepository @Inject constructor(
    ...
    suspend fun getEventList(month: String, day: String, limit: Int, offset: Int): Resource<Events> {
        return try {
    ...
    suspend fun getEventListOfType(type: String, month: String, day: String): Resource<List<Selected>> {
        return try {
